...
# Si es así, imprima un mensaje que diga "La cadena ingresada contiene al menos una 
# letra y al menos un número". De lo contrario, imprima un mensaje que diga 
# "La cadena ingresada no contiene al menos una letra y al menos un número".